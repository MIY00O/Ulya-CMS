				...
				<div class="col-lg-4 mb-4">
					<div class="card border-0 shadow-sm mb-2">
						...
						<div class="d-flex justify-content-center mb-3">
							<small class="mx-3"><i class="fa fa-user text-danger"></i> <?= $uu['nama'] ?></small>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 wp1">
					...
					<!-- about / welcome text -->
					<p class="text-white">Halo perkenalkan Nama Saya Ulya Amelia Putri biasa di panggil Ulya, Saya Lahir di Karanganyar
							...
							<p>
								<div class="social-links mt-3">
									<ul class="list-unstyled custom-social">
										<li><a href="<?= $konfig->facebook; ?>" class="social-btn"><i
													class="fa fa-facebook"></i></a></li>
										<br><li><a href="<?= $konfig->instagram; ?>" class="social-btn"><i
